...
.support-online .phone-icon{
    background:url(<?php echo $this->skin->get_skin_instance('phone_icons')->get_skin_link($instance['phone_icon'])?>);
...
.support-online .email-icon{
    background:url(<?php echo $this->skin->get_skin_instance('mail_icons')->get_skin_link($instance['mail_icon'])?>);
    background-size: 20px 20px;
  background-repeat: no-repeat;
  padding-top: 5px;
  padding-bottom: 5px;
